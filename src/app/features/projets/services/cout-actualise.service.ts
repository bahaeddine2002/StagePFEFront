...
export class CoutActualiseService {
  private baseUrl = environment.baseUrl;

  constructor(private http: HttpClient) {}

  getCoutActualise(projectId: number): Observable<CoutPrevisionnelResponse> {
    return this.http.get<CoutPrevisionnelResponse>(
      this.baseUrl +
        `application-service/api/projets/${projectId}/cout-actualise`,
    );
  }
